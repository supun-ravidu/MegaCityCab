    ...
    <div class="guide-container">
        ...
        <div class="section">
            ...
            <div class="section-content" id="booking">
                <ul>
                    ...
                    <li>🎯 <strong>Confirm and Ride</strong> – Done! Your booking is successful!</li>
        ...
        <div class="section">
            ...
            <div class="section-content" id="dashboard">
                <ul>
                    ...
                    <li>🗺️ <strong>Live Map Feature</strong> – See location and car routes.</li>
        ...
        <div class="section">
            <div class="section-title" onclick="toggleSection('troubleshooting')">
                <i class="fas fa-tools"></i> ❌ Registration and Login Issues? No Worries!
            </div>
